...
for i in range(40):  # Change to 10 for part 1
    ...
    for key in inserts:
        if key in pairs:
            ...
            newPairs[key[0] + inserts[key]] = newPairs[key[0] + inserts[key]] + pairs[key] if key[0] + inserts[
                key] in newPairs else pairs[key]
            newPairs[inserts[key] + key[1]] = newPairs[inserts[key] + key[1]] + pairs[key] if inserts[key] + key[
                1] in newPairs else pairs[key]
